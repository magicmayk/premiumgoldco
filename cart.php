...
<button class="btn btn-warning" type="submit" name="checkout" value="Proceed to Checkout">
...
<!-- you also like these products start -->
...
<img src='admin_area/product_images/$pro_img1' class='img-responsive height-constraint-2' >
