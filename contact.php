...
$owner_email = 'premiumgoldcotest@gmail.com';
...
mail($owner_email,$sender_subject,$new_message,$headers);

// Send email to sender through this code

$email = $_POST['email'];

$subject = "Thank you for shopping with Premium Gold Co.";

$msg = "I shall get you soon, thanks for sending us email";

$from = "From: premiumgoldcotest@gmail.com \r\n";

$from .= "Content-type: text/html\r\n";

mail($sender_email,$subject,$msg,$from);
