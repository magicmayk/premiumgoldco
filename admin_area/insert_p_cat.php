...
<label class="col-md-3 control-label" > Select Product Title Image</label>

<div class="col-md-6" >

<input type="file" name="p_cat_title_image" class="form-control" >
...
$p_cat_title_image = $_FILES['p_cat_title_image']['name'];

$temp_name = $_FILES['p_cat_image']['tmp_name'];
$temp2_name = $_FILES['p_cat_title_image']['tmp_name'];

move_uploaded_file($temp_name,"other_images/$p_cat_image");
move_uploaded_file($temp2_name,"other_images/$p_cat_title_image");

$insert_p_cat = "insert into product_categories (p_cat_title,p_cat_top,p_cat_image,p_cat_title_image) values ('$p_cat_title','$p_cat_top','$p_cat_image','$p_cat_title_image')";
