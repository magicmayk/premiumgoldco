...
$from = "premiumgoldcotest@gmail.com";

$message = "
<h2>
Email Confirmation by Premium Gold Co. $c_name
</h2>
<a href='localhost/ecommerce-website-master/customer/my_account.php?$customer_confirm_code'>
...
$insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,customer_address,customer_image,customer_ip,customer_confirm_code) values ('$c_name','$c_email','$hash','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip','$customer_confirm_code')";
