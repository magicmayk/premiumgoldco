...
INSERT INTO `product_categories` (`p_cat_id`, `p_cat_title`, `p_cat_top`, `p_cat_image` , `p_cat_url`) VALUES
(4, 'Coats', 'no', 'image3.jpg', 'cat-1'),
(5, 'T-Shirts', 'no', 'image2.jpg', 'cat-2'),
(6, 'Sweater', 'no', 'sweater.jpg', 'cat-3'),
(7, 'jackets', 'yes', 'jacket.jpg', 'cat-4');
