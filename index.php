...
?> 
  ...
  <main>
    ...
    <!-- Main -->
    <div class="wrapper2">
            <h1><p class="product-heading"><b>NEW ARRIVALS</b></p></h1>
    ...
    <div class="row arrivals-container"><!-- row Starts -->
    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            <div class="email">
              Email:
              <a href="mailto:support@yourwebsite.com" class="email__addr">premiumgoldco@gmail.com</a>
              <img src="images/PGLogoBlack.png" class= "footerLogo">
            </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; 2020 Premium Gold Co.&trade;
          </div>

          <div class="developer">
            Dev by Michael de Jesus
          </div>

          <div class="designby">
            Design by Michael de Jesus
          </div>
